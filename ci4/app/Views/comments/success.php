...
<li class="nav-item"><a class="nav-link js-scroll-trigger" href="/~anvillaflor/lab3/ci4/public/home#about">About</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/~anvillaflor/lab3/ci4/public/home#forms">Feedback</a></li>

                </ul>
            </div>
        </nav>
		
		<div class = "success-center padd-15"> <!-- === Success-Center Start === -->

    <h1 class = "success-h1 ">Comment Posted Successfully!</h1>
	<p class = "success-p"> thank you so much for giving me a feedback.
    </p>
	<div class = "success-btn">
    <a href="/~anvillaflor/lab3/ci4/public/comments">
         <button type="submit" class="btn btn-success">Go Back</button>
    </a>
	</div>
	
</div> <!-- === Success-Center End === -->
